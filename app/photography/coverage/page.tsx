    ...
    <div className="coverage-shell">
      ...
      <header className="coverage-opening">
        ...
        <aside className="coverage-price" aria-label="Volleyball match package price">
          ...
          <p className="coverage-price-note">Schools and established organizations: no deposit; invoice due 30 days after the event. Individuals: $175 deposit; $175 when the gallery is ready, before full-resolution downloads. <a href="#coverage-payment">Payment details</a>.</p>
