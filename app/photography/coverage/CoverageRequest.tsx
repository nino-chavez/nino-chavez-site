...
export function CoverageRequest() {
  ...
  async function sendRequest(event: FormEvent<HTMLFormElement>) {
    ...
    if (date < earliestCoverageDate() || date > offer.lastDate) { setError("Choose an upcoming date between September 19 and December 31, 2026."); return; }
  ...
  return <div className="coverage-request">
    ...
    {receipt && <div className="coverage-email" ref={preview} tabIndex={-1} role="status">
      ...
      <p>Your date is not booked yet. Booking follows written confirmation, access approval and the agreed payment arrangement.</p>
