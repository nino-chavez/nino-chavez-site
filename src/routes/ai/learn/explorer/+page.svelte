		...
		{#if mounted}
			...
			>
				<p class="text-sm" style="color: var(--ai-text-muted);">
					...
					Email me at <a href="mailto:abelino.chavez@gmail.com" style="color: var(--ai-accent-purple);">abelino.chavez@gmail.com</a> with your blockers. Common issues: prompt feels generic, not sure what to reflect on, outputs don't feel useful.
				</p>
			</div>
		{/if}
	</section>
